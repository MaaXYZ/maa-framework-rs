...
pub type MaaStringListBufferHandle = *mut MaaStringListBuffer;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct MaaImageListBuffer {
    _unused: [u8; 0],
}
pub type MaaImageListBufferHandle = *mut MaaImageListBuffer;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Touch_MaaTouch: MaaAdbControllerTypeEnum =
    3;
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Touch_EmulatorExtras:
    MaaAdbControllerTypeEnum = 4;
...
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Key_MaaTouch: MaaAdbControllerTypeEnum =
    512;
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Key_EmulatorExtras:
    MaaAdbControllerTypeEnum = 768;
...
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Input_Preset_EmulatorExtras:
    MaaAdbControllerTypeEnum = 772;
#[doc = " \\deprecated"]
...
#[doc = " \\deprecated"]
pub const MaaAdbControllerTypeEnum_MaaAdbControllerType_Screencap_EmulatorExtras:
    MaaAdbControllerTypeEnum = 524288;
#[doc = " \\deprecated"]
...
pub const MaaWin32ControllerTypeEnum_MaaWin32ControllerType_Touch_Seize:
    MaaWin32ControllerTypeEnum = 2;
pub const MaaWin32ControllerTypeEnum_MaaWin32ControllerType_Key_SendMessage:
    MaaWin32ControllerTypeEnum = 256;
pub const MaaWin32ControllerTypeEnum_MaaWin32ControllerType_Key_Seize: MaaWin32ControllerTypeEnum =
    512;
...
extern "C" {
    pub fn MaaControllerPostStartApp(ctrl: MaaControllerHandle, intent: MaaStringView)
        -> MaaCtrlId;
}
extern "C" {
    pub fn MaaControllerPostStopApp(ctrl: MaaControllerHandle, intent: MaaStringView) -> MaaCtrlId;
}
extern "C" {
...
extern "C" {
    pub fn MaaSyncContextRunRecognition(
        sync_context: MaaSyncContextHandle,
        image: MaaImageBufferHandle,
        task_name: MaaStringView,
...
extern "C" {
    pub fn MaaSyncContextCachedImage(
        sync_context: MaaSyncContextHandle,
        out_image: MaaImageBufferHandle,
    ) -> MaaBool;
}
...
extern "C" {
    pub fn MaaCreateStringListBuffer() -> MaaStringListBufferHandle;
}
extern "C" {
    pub fn MaaDestroyStringListBuffer(handle: MaaStringListBufferHandle);
}
extern "C" {
    pub fn MaaIsStringListEmpty(handle: MaaStringListBufferHandle) -> MaaBool;
}
extern "C" {
    pub fn MaaClearStringList(handle: MaaStringListBufferHandle) -> MaaBool;
}
extern "C" {
    pub fn MaaGetStringListSize(handle: MaaStringListBufferHandle) -> MaaSize;
}
extern "C" {
    pub fn MaaGetStringListAt(
        handle: MaaStringListBufferHandle,
        index: MaaSize,
    ) -> MaaStringBufferHandle;
}
extern "C" {
    pub fn MaaStringListAppend(
        handle: MaaStringListBufferHandle,
        value: MaaStringBufferHandle,
    ) -> MaaBool;
}
extern "C" {
    pub fn MaaStringListRemove(handle: MaaStringListBufferHandle, index: MaaSize) -> MaaBool;
}
extern "C" {
...
extern "C" {
    pub fn MaaCreateImageListBuffer() -> MaaImageListBufferHandle;
}
extern "C" {
    pub fn MaaDestroyImageListBuffer(handle: MaaImageListBufferHandle);
}
extern "C" {
    pub fn MaaIsImageListEmpty(handle: MaaImageListBufferHandle) -> MaaBool;
}
extern "C" {
    pub fn MaaClearImageList(handle: MaaImageListBufferHandle) -> MaaBool;
}
extern "C" {
    pub fn MaaGetImageListSize(handle: MaaImageListBufferHandle) -> MaaSize;
}
extern "C" {
    pub fn MaaGetImageListAt(
        handle: MaaImageListBufferHandle,
        index: MaaSize,
    ) -> MaaImageBufferHandle;
}
extern "C" {
    pub fn MaaImageListAppend(
        handle: MaaImageListBufferHandle,
        value: MaaImageBufferHandle,
    ) -> MaaBool;
}
extern "C" {
    pub fn MaaImageListRemove(handle: MaaImageListBufferHandle, index: MaaSize) -> MaaBool;
}
extern "C" {
...
extern "C" {
    pub fn MaaQueryRecognitionDetail(
        reco_id: MaaRecoId,
        hit: *mut MaaBool,
...
extern "C" {
    pub fn MaaQueryRunningDetail(
        run_id: MaaRunningId,
        reco_id: *mut MaaRecoId,
        successful: *mut MaaBool,
    ) -> MaaBool;
}
extern "C" {
...
extern "C" {
    #[doc = " \\deprecated Use MaaToolkitPostFindDevice() and MaaToolkitWaitForFindDeviceToComplete()\n instead."]
    pub fn MaaToolkitFindDevice() -> MaaSize;
}
extern "C" {
    #[doc = " \\deprecated Use MaaToolkitPostFindDeviceWithAdb() and\n MaaToolkitWaitForFindDeviceToComplete() instead."]
...
extern "C" {
    pub fn MaaToolkitClearCustomRecognizerExecutor(handle: MaaInstanceHandle) -> MaaBool;
}
extern "C" {
...
extern "C" {
    pub fn MaaToolkitClearCustomActionExecutor(handle: MaaInstanceHandle) -> MaaBool;
}
extern "C" {
...
extern "C" {
    #[doc = " @brief Get the window class name by hwnd.\n\n @param hwnd The window hwnd.\n @param buffer The output buffer.\n @return MaaBool."]
    pub fn MaaToolkitGetWindowClassName(
        hwnd: MaaWin32Hwnd,
        buffer: MaaStringBufferHandle,
    ) -> MaaBool;
}
extern "C" {
    #[doc = " @brief Get the window window name by hwnd.\n\n @param hwnd The window hwnd.\n @param buffer The output buffer.\n @return MaaBool."]
    pub fn MaaToolkitGetWindowWindowName(
        hwnd: MaaWin32Hwnd,
        buffer: MaaStringBufferHandle,
    ) -> MaaBool;
}
