...
pub const MaaWin32InputMethod_AnchoredTouch: u32 = 1024;
...
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperCreate() -> *mut MaaToolkitPortalHelper;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperDestroy(helper: *mut MaaToolkitPortalHelper);
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperOpenStream(helper: *mut MaaToolkitPortalHelper) -> MaaBool;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperGetPersist(helper: *mut MaaToolkitPortalHelper) -> MaaBool;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperSetPersist(helper: *mut MaaToolkitPortalHelper, enable: MaaBool);
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperGetPipeWireFD(
        helper: *mut MaaToolkitPortalHelper,
    ) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperGetPipeWireNodeID(helper: *mut MaaToolkitPortalHelper) -> u32;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperGetRestoreToken(
        helper: *mut MaaToolkitPortalHelper,
    ) -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn MaaToolkitPortalHelperSetRestoreToken(
        helper: *mut MaaToolkitPortalHelper,
        token: *const ::std::os::raw::c_char,
    );
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceListCreate() -> *mut MaaToolkitGamescopeInstanceList;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceListDestroy(handle: *mut MaaToolkitGamescopeInstanceList);
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceFindAll(
        buffer: *mut MaaToolkitGamescopeInstanceList,
    ) -> MaaBool;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceListSize(
        list: *const MaaToolkitGamescopeInstanceList,
    ) -> MaaSize;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceListAt(
        list: *const MaaToolkitGamescopeInstanceList,
        index: MaaSize,
    ) -> *const MaaToolkitGamescopeInstance;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceGetDisplayNo(
        instance: *const MaaToolkitGamescopeInstance,
    ) -> u32;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceGetPipeWireNodeId(
        instance: *const MaaToolkitGamescopeInstance,
    ) -> u32;
}
unsafe extern "C" {
    pub fn MaaToolkitGamescopeInstanceGetEisSocketPath(
        instance: *const MaaToolkitGamescopeInstance,
    ) -> *const ::std::os::raw::c_char;
}
