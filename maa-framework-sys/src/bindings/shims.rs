...
shim ! (MaaLinuxControllerCreate (config_json : * const :: std :: os :: raw :: c_char) -> * mut MaaController) ;
...
shim ! (MaaToolkitPortalHelperCreate () -> * mut MaaToolkitPortalHelper) ;
shim ! (MaaToolkitPortalHelperDestroy (helper : * mut MaaToolkitPortalHelper) -> ()) ;
shim ! (MaaToolkitPortalHelperOpenStream (helper : * mut MaaToolkitPortalHelper) -> MaaBool) ;
shim ! (MaaToolkitPortalHelperGetPersist (helper : * mut MaaToolkitPortalHelper) -> MaaBool) ;
shim ! (MaaToolkitPortalHelperSetPersist (helper : * mut MaaToolkitPortalHelper , enable : MaaBool) -> ()) ;
shim ! (MaaToolkitPortalHelperGetPipeWireFD (helper : * mut MaaToolkitPortalHelper) -> :: std :: os :: raw :: c_int) ;
shim ! (MaaToolkitPortalHelperGetPipeWireNodeID (helper : * mut MaaToolkitPortalHelper) -> u32) ;
shim ! (MaaToolkitPortalHelperGetRestoreToken (helper : * mut MaaToolkitPortalHelper) -> * const :: std :: os :: raw :: c_char) ;
shim ! (MaaToolkitPortalHelperSetRestoreToken (helper : * mut MaaToolkitPortalHelper , token : * const :: std :: os :: raw :: c_char) -> ()) ;
shim ! (MaaToolkitGamescopeInstanceListCreate () -> * mut MaaToolkitGamescopeInstanceList) ;
shim ! (MaaToolkitGamescopeInstanceListDestroy (handle : * mut MaaToolkitGamescopeInstanceList) -> ()) ;
shim ! (MaaToolkitGamescopeInstanceFindAll (buffer : * mut MaaToolkitGamescopeInstanceList) -> MaaBool) ;
shim ! (MaaToolkitGamescopeInstanceListSize (list : * const MaaToolkitGamescopeInstanceList) -> MaaSize) ;
shim ! (MaaToolkitGamescopeInstanceListAt (list : * const MaaToolkitGamescopeInstanceList , index : MaaSize) -> * const MaaToolkitGamescopeInstance) ;
shim ! (MaaToolkitGamescopeInstanceGetDisplayNo (instance : * const MaaToolkitGamescopeInstance) -> u32) ;
shim ! (MaaToolkitGamescopeInstanceGetPipeWireNodeId (instance : * const MaaToolkitGamescopeInstance) -> u32) ;
shim ! (MaaToolkitGamescopeInstanceGetEisSocketPath (instance : * const MaaToolkitGamescopeInstance) -> * const :: std :: os :: raw :: c_char) ;
